...
public enum RestFilterOp implements EnumClass<String> {
    ...
    RestFilterOp(String forJpql,String forGroovy, boolean unary) {
    ...
    public static RestFilterOp fromGroovyString(String str) {
        for (RestFilterOp op : values()) {
    ...
    public String getLocCaption() {
        return AppBeans.get(Messages.class).getMainMessage("RestFilterOp." + this.name());
    }
